...
const {DB_USER, DB_PASSWORD, DB_HOST, DB_NAME} = process.env;  // variable entorno
let sequelize =
...
const { Videogames, Genres, Plataforms } = sequelize.models; // Modelos de sequelize las tablas que se crearon
